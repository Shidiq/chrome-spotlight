// Query helpers shared by the spotlight overlay (content.js), the options page
// and the sidebar. The sidebar's side panel has no content script, so these
// can't stay inside the content.js IIFE.
(() => {
  "use strict";
